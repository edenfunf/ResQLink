...
DELIVERABLES: tuple[DeliverableSpec, ...] = (
    ...
    DeliverableSpec(
        ...
        members=("line_broadcast", "line_rich_menu"),
        front=DeliverableLink(
    ...
    DeliverableSpec(
        key="eoc_ops",
        name="應變中心作業",
        tagline="簡訊與廣播稿、情勢報告、會議簡報、跨縣市支援與災後檢討等行政文書。",
        members=(
            "sms_alert_draft",
            "radio_script",
            "field_survey_form",
        ...
        front=DeliverableLink(label="事件情勢總覽", url_template="/incidents/{id}"),
        admin=DeliverableLink(label="事件詳情後台", url_template="/incidents/{id}"),
        accent="#565a66",
        icon="doc",
    ),
)
